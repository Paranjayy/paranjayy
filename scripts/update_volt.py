...
def update_volt():
    # Only All-Time stats as requested
    ...
    try:
        ...
        svg_content = f"""<svg width="400" height="110" viewBox="0 0 400 110" fill="none" xmlns="http://www.w3.org/2000/svg">
  <rect width="400" height="110" rx="12" fill="#171A20"/>
  <rect x="0.5" y="0.5" width="399" height="109" rx="11.5" stroke="#2D333B" stroke-opacity="0.5"/>
  ...
  <g transform="translate(20, 75)">
    <text x="0" y="0" fill="#8B949E" font-family="Segoe UI, sans-serif" font-size="11" font-weight="bold">PLAYS</text>
    <text x="0" y="20" fill="#1DB954" font-family="Segoe UI, sans-serif" font-weight="bold" font-size="16">{data['plays']}</text>
    
    <text x="120" y="0" fill="#8B949E" font-family="Segoe UI, sans-serif" font-size="11" font-weight="bold">MINUTES</text>
    <text x="120" y="20" fill="#1DB954" font-family="Segoe UI, sans-serif" font-weight="bold" font-size="16">{data['minutes']}</text>
    
    <text x="240" y="0" fill="#8B949E" font-family="Segoe UI, sans-serif" font-size="11" font-weight="bold">SONGS</text>
    <text x="240" y="20" fill="#F0F6FC" font-family="Segoe UI, sans-serif" font-weight="bold" font-size="16">{data['songs']}</text>
        ...
        with open("metrics/volt-card.svg", "w") as f:
            f.write(svg_content)
        print("Volt.fm card updated (Simplified & Logo added).")
